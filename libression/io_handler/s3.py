...
class S3IOHandler(libression.entities.io.IOHandler):
    ...
    def list_objects(
        ...
        response = self.client.list_objects_v2(
            ...
            Prefix=prefix,
            Delimiter=(
                "/" if subfolder_contents else None
            ),  # Use delimiter for ls-like behavior
        )
    ...
    def copy(self, source_path: str, destination_path: str) -> None:
        ...
        copy_source = {"Bucket": self.bucket_name, "Key": source_path.lstrip("/")}
    ...
    def delete(self, filepath: str) -> None:
        ...
        self.client.delete_object(Bucket=self.bucket_name, Key=filepath.lstrip("/"))
    ...
    def bytestream(self, filepath: str) -> typing.IO[bytes]:
        ...
        try:
            ...
            raise FileNotFoundError(
                f"Object {filepath} not found in bucket {self.bucket_name}"
            )
'''
